  ...
  return (
    <div>
      <section className="relative px-4 pb-4 md:px-6 md:pb-6 lg:px-8 pt-[88px] z-10 xl:px-12">
        <div className="relative border border-white/20 rounded-[2rem] overflow-hidden backdrop-blur-sm bg-white/5 shadow-2xl transition-all duration-700 hover:border-white/30 section-padding">
          ...
          {/* Form */}
          <ScrollReveal>
            <span className="text-[#FFD700] font-heading font-semibold text-sm tracking-wider uppercase mb-4 block">Get in Touch</span>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold text-white leading-[1.1] mb-4 md:mb-6">
              Book Your Consultation
            </h1>
            <p className="text-white/80 mb-2 text-sm">Next available slot in 3 days</p>
          ...
          <ScrollReveal delay={0.2}>
            <div className="space-y-6 md:space-y-8">
                ...
                <div className="space-y-6">
                  <a href="tel:+17135551234" className="flex items-center gap-5 group">
                    ...
                    <div>
                      ...
                      <p className="text-white/60 text-sm md:text-base group-hover:text-white transition-colors">(713) 555-1234</p>
                    </div>
                  </a>
                  <a href="mailto:info@perioimplant.com" className="flex items-center gap-5 group">
                    ...
                    <div>
                      ...
                      <p className="text-white/60 text-sm md:text-base group-hover:text-white transition-colors break-all">info@perioimplant.com</p>
                    </div>
                  </a>
                  <div className="flex items-start gap-5">
                    ...
                    <div>
                      ...
                      <p className="text-white/60 text-sm md:text-base leading-relaxed">1234 Medical Center Blvd<br />Houston, TX 77030</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-[2rem] overflow-hidden border border-white/10 shadow-2xl h-64 md:h-72 group relative">
                <div className="absolute inset-0 bg-accent/5 pointer-events-none group-hover:opacity-0 transition-opacity" />
                <iframe
              ...
              <div className="flex items-center gap-3 md:gap-4 justify-center flex-wrap">
                {["ADA Member", "Board Certified", "HIPAA Compliant"].map((badge) => (
                  <div key={badge} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl px-4 py-2 text-xs font-bold text-white/50 hover:text-white hover:border-white/30 transition-all uppercase tracking-widest">
                    {badge}
                  </div>
                ))}
              </div>
